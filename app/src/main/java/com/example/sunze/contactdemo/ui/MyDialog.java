...
public class MyDialog extends Dialog implements View.OnClickListener {
    ...
    private com.example.sunze.contactdemo.listener.onDialogClickListener onDialogClickListener;
     ...
     * 设置确定按钮的点击回调
     */
    public void onCallClicklistener(com.example.sunze.contactdemo.listener.onDialogClickListener onDialogClickListener){
